...
<center>
					<img src="images/avatar.png" class="avatar"  style="width:200px;"/><br>
        <input type="file" id="imglink" name="imglink" accept=".jpg,.jpeg,.png" onchange="PreviewImage();"/><br><br>
</center>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="pass" placeholder="*************" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
						<span class="focus-input100"></span>
					</div>
...
if(isset($_POST['submit']))
{
	...
	if($pass==$cpass)
				{
					...
					if(mysqli_num_rows($query_run)>0)
					{
						...
						echo '<script type="text/javascript"> alert("User already exists.. try another username or email") </script>';
					}
					...
					else
					{
						...
						$query= "insert into customer values('','$name','$email','$username','$pass','$cpass','$target_file','','','','')";
						$query_run = mysqli_query($con,$query);
	...
	{
    echo '<script type="text/javascript">  alert(" Password and confird password does not match") </script> ';  
	}
}
?>
